  ...
  return (
    <div className="">
      ...
      <div className="relative w-full pt-2">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-2 sm:px-6 lg:px-8 shadow-xs bg-white ">
          <div className="inline-flex items-center space-x-2 ">
            ...
            <Link to="/" className="font-bold" >MyCollege</Link>
          </div>
        ...
        <hr className="my-5 h-0.5 w-[99%] m-auto border-t-0 bg-neutral-300 opacity-100 dark:opacity-50" />
      </div>
